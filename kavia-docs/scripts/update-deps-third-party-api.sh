...
# This script should be copied into the Third-Party API repository (teljira-326-1862)
...
if [ ! -f package.json ]; then
  echo "package.json not found. Run this script from the Third-Party API repository root."
  exit 1
fi
